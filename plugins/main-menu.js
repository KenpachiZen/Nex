...
rows: [
{title: `🗒️ ALL MENU`, rowId: ".? all", description: "♦ Menampilkan Semua Menu"},
	    {title: `🖥 RPG GAMES`, rowId: ".? rpg", description: "⊛ RPG Game"},
	{title: `✨ EXP`, rowId: ".? xp", description: "⊛ Lupa Menu Apa Wkwk"},
	{title: `🎮 GAME MENU`, rowId: ".? game", description: "⊛ Menu Game Yang Ada Di Bot"},
	{title: `🧩 FUN MENU`, rowId: ".? fun", description: "Menu Gabut Awokawok"},
	{title: `🐚 KERANG AJAIB`, rowId: ".? kerangajaib", description: "Buat Tanya² Ke Bot"},
	{title: `📑 QUOTES`, rowId: ".? quotes", description: "╰► Ada yg mau nyari topik nih... >-<"},
	{title: `⛩️ ANIME`, rowId: ".? anime", description: "⊛ Cari Anime Dll"},
	{title: `🔞 NSFW`, rowId: ".? nsfw", description: "• Fitur Apakah Ini ?"},
	{title: `📚 EDUKASI`, rowId: ".? edukasi", description: "Belajar Dari Bot"},
	{title: `🌟 PREMIUM`, rowId: ".? premium", description: "⊛ Menu Khusus User Premium"},
	{title: `🎭 ANONYMOUS`, rowId: ".? anonymous", description: "⊛ Menu Anonymous"},
	{title: `☪️ Islam`, rowId: ".? quran", description: "⊛ Menu Islamic"},
	{title: `🌐 INTERNET`, rowId: ".? internet", description: "⊛ Buat Nyari Sesuatu Pake Bot"},
	{title: `📤️ DONWLOAD MENU`, rowId: ".? downloader", description: "⊛ Mau Download Apa Bang? "},
	{title: `🃏 STICKER`, rowId: ".? stiker", description: "⊛ Untuk Membuat Stiker"},
	{title: `✏️ NULIS`, rowId: ".? nulis", description: "⊛ Menu Nulis"},
	{title: `🎵 AUDIO`, rowId: ".? audio", description: "⊛ Jeje Rimek"},
        {title: `🎶 SOUND`, rowId: ".soundmenu", description: "⊛ Jeje RimekV2"},
	{title: `🎦 PRESET AM`, rowId: ".presetmenu", description: "⊛ Preset Alight Motion"},
	{title: `🔐 GROUP`, rowId: ".? group", description: "⊛ Fitur Khusus Group"},
	{title: `☢️ ADMIN GROUP`, rowId: ".? admin", description: "⊛ Fitur Khusus Admin Group"},
	{title: `🗃️️ DATABASE`, rowId: ".? database", description: "⊛ Menu Untuk Menyimpan File"},
	{title: `🧰️ TOOLS`, rowId: ".? tools", description: "⊛ Males Ngetik"},
	{title: `️️📊️ INFO`, rowId: ".? info", description: "⊛ Menu Info"},
	{title: `👩‍💻 MENU OWNER`, rowId: ".? owner", description: "⊛ Fitur Khusus Owner Atau Creator Bot"},
	{title: `🎨 MAKER`, rowId: ".? maker", description: "⊛ Untuk Membuat Logo"},
	{title: `🪙 STORE`, rowId: ".? store", description: "⊛ Bot Store : List Store"},
	{title: `🔥 Virtex`, rowId: ".? virus", description: "⊛ Bang Jangan Bang Ga Immune Botnya"},
]
}, {
title: `⃟⟣⟚⟝ ⟡ Support Me ${namebot} ⟡ ⟞⟚⟢⃟`,
rows: [
{title: `🔖 SEWA`, rowId: ".sewa", description: "⊛ List Harga Sewa Bot"},
	    {title: `🌟 BUY PREMIUM`, rowId: ".premium", description: "⊛ List Harga Premium User"},
	    {title: `💹 DONASI`, rowId: ".donasi", description: '⊛ Donasi Biar Botnya Fast Respon'},
]}]
...
▢ ▱▱▱▱▱▱▱▱▱▱▱▱ ▢  
`
let fot = `Kalo Botnya Off Sabar Ye Ngab 
`
const listMessage = {
text: tett,
footer: fot,
